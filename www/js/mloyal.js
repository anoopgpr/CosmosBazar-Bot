...
var SERVER = "https://cosmobazaar.mloyalretail.com/apis/";
var SERVER1 = "https://cosmobazaar.mloyalretail.com/m/"; 
...
$(document).ready(function(event){
				 ...
				 var stid = localStorage.getItem("st_cosmobazaarbot");
				 ...
				 if(stid=='') 
	                 {
					  ...
					  {
						if(localStorage.getItem("username_cosmobazaarbot")!=null && localStorage.getItem("username_cosmobazaarbot")!='' && localStorage.getItem("password_cosmobazaarbot")!=null && localStorage.getItem("password_cosmobazaarbot")!='')
	                    {
	                           $('#username_store').val(localStorage.getItem("username_cosmobazaarbot"));
	                           $('#password_store').val(localStorage.getItem("password_cosmobazaarbot"));
		   ...
		   //called when complete
			...
			success: function(data, textStatus, xhr) {
			    ...
			    //console.log(textStatus);
				 ...
				 localStorage.setItem("st_cosmobazaarbot",user.store_id);
				 localStorage.setItem("stcode_cosmobazaarbot",user.store_code);

				 localStorage.setItem("st1_cosmobazaarbot",uname);
				 localStorage.setItem('username_cosmobazaarbot',uname);
				 localStorage.setItem('password_cosmobazaarbot',pass);
  ...
  else
  {
    ...
    $.ajax({
     ...
     data: {
				...
				'mobileno': mob,
				'coupon_code': rcode,
				'storeuid':  localStorage.getItem("username_cosmobazaarbot"),
				'storepswd': localStorage.getItem("password_cosmobazaarbot")
			},
